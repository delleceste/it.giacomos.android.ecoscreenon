...
import it.giacomos.android.ecosmartscreenon.remoteview.NotificationRemoteViews;
...
public class EcoScreenService extends Service implements StateListener, ActivityBroadcastReceiverListener
{
	...
	private NotificationRemoteViews mNotificationView;
	...
	public int onStartCommand(Intent intent, int flags, int startId) 
	{
		...
		mNotificationView = new NotificationRemoteViews(getPackageName(),
                R.layout.notification_remote_view);
		
		Intent motionDetectionToggleIntent = new Intent(this, NotificationViewIntentListener.class);
		motionDetectionToggleIntent.setAction(NotificationViewIntentListener.TOGGLE_MOTION_DETECTION_ENABLE);
		
		PendingIntent enableMotionDetectionPendingIntent = PendingIntent.getBroadcast(this, 
				mEcoScreenServiceId, motionDetectionToggleIntent, PendingIntent.FLAG_UPDATE_CURRENT);
		mNotificationView.setOnClickPendingIntent(R.id.btMotionDetection, enableMotionDetectionPendingIntent);
...
//			Toast.makeText(this, "No user action detected", Toast.LENGTH_LONG).show();
	...
	private void mBuildNotification(Action a)
	{
		...
		if(mConfiguration.mMotionDetectionEnabled)
			...
			motionDetectionEnabled = getResources().getString(R.string.enable_motion_detection);
